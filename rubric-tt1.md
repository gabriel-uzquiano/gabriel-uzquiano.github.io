...
The test will be scored out of **100 points**, with **four arguments each worth 25 points**. We will apply the usual scale to convert these numerical scores into a proficiency standard:
...
### premise-conclusion (5 pts)

| Mistake              | Deduction |
| -------------------- | --------- |
| incorrect premises   | -2 pts    |
| incorrect conclusion | -2 pts    |

**Students will receive at least 3 pts (our of 5) for having submitted an answer.**

**No credit will be given to questions *without* an answer.** 

### translation (10 pts)
In order to avoid a double penalty, we evaluate the translation of the argument they reconstructed. 
...
**Students will receive at least 4 pts (our of 10) for having submitted an answer.**
